...
namespace LBL
{
	namespace NT68400
	{
		...
		public:
			...
			virtual quint16 readAllDPAdvanceData_PIP(quint16 param, quint8 channel, bool sync, int msec)override;
			virtual quint16 readAllDPAdvanceData_VideoWall(quint16 param, quint8 channel, bool sync, int msec)override;
			virtual quint16 resetHDMISetting(bool sync, int msec) override;
			//DP-TX
			virtual quint16 writeDP_TX(quint8 param, quint8 channel, bool sync, int msec)override;
			virtual quint16 readDP_TX(quint8 channel, bool sync, int msec)override;
			...
			virtual quint16 writeSys_DsiplayArea(quint16 width, quint16 height, bool sync, int msec)override;
			virtual quint16 readSys_DsiplayArea(bool sync, int msec)override;
