...
namespace LBL
{
    namespace SCItem
    {
        ...
        public:
            ...
            void checkItemInfo();
            //发送卡属性
            virtual int maxPortCount() const;
            virtual bool hasMS9570() const;
            virtual bool hasNT68400() const;
            virtual bool hasAndroid() const;
            /*********************************************************************************************************
            **发送卡相关接口
            *********************************************************************************************************/
            ...
            virtual quint16 writeSCNT68400Resolution(quint8 value, bool sync, int msec);
            virtual QByteArray readSCNT68400Resolution(bool sync, int msec);
            virtual quint8  getSCNT68400Resolution();

            virtual quint16 writeSC10BitSource(quint8 value, bool sync, int msec);
            virtual QByteArray readSC10BitSource(bool sync, int msec);
            virtual quint8  getSC10BitSource();

            virtual quint16 writeSCLowDelay(quint8 value, bool sync, int msec);
            virtual QByteArray readSCLowDelay(bool sync, int msec);
            virtual quint8  getSCLowDelay();
            /*********************************************************************************************************
            **连接关系相关
            *********************************************************************************************************/
            ...
            *********************************************************************************************************/
            ...
            virtual quint16 readAllHDMIAdvanceData_PIP(quint8 param, quint8 channel, bool sync, int msec);

            virtual quint16 writeHDMIOutputSource(quint8 hdmi1, quint8 hdmi2, quint8 dp, quint8 channel, bool sync, int msec);
            virtual quint16 readHDMIOutputSource(quint8 channel, bool sync, int msec);
            virtual QList<quint8> getHDMIOutputSource();

            virtual quint16 writeDP_TX_Pcon600(quint8 hdmi1, quint8 hdmi2, quint8 dp, quint8 channel, bool sync, int msec);
            virtual quint16 readDP_TX_Pcon600(quint8 channel, bool sync, int msec);
            virtual bool   getDP_TX_Pcon600(quint8 &hdmi1, quint8 &hdmi2, quint8 &dp);

            virtual quint16 writeDP_TX_2ndPlus(quint8 param, quint8 channel, bool sync, int msec);
            virtual quint16 readDP_TX_2ndPlus(quint8 channel, bool sync, int msec);
            virtual quint8  getDP_TX_2ndPlus();
            ...
            virtual quint16 writeHDIMIAudioVolume(quint8 param, quint8 channel, bool sync, int msec);
            virtual quint16 readHDIMIAudioVolume(quint8 channel, bool sync, int msec);
            virtual quint8  getHDIMIAudioVolume();

            virtual quint16 writeHDIMISharpness(quint8 param, quint8 channel, bool sync, int msec);
            virtual quint16 readHDIMISharpness(quint8 channel, bool sync, int msec);
            virtual quint8  getHDIMISharpness();

            virtual quint16 writeHDIMIDisplayArea(QSize value, quint8 channel, bool sync, int msec);
            virtual quint16 readHDIMIDisplayArea(quint8 channel, bool sync, int msec);
            virtual QSize  getHDIMIDisplayArea();

            //EDID
            virtual QByteArray GetEDIDData() ;
            virtual quint16 writeFacTest_UpdateEDID(quint8 dataGroupIndex, quint8* pDataBuff, quint8 dataLen, bool sync, int msec);
