	...
	namespace SCItem
	{
		...
		public:
			...
			*********************************************************************************************************/
			...
			virtual quint16 upgradeFile(bool sync, int msec, quint16 fileType, QString fileName, quint8 portIndex, quint16 moduleIndex) override;
			virtual quint16 upgradeFile(bool sync, int msec, quint16 fileType, QByteArray data) override;
			virtual quint16 upgradeFile(bool sync, int msec, quint16 fileType, QByteArray dat, quint8 portIndex, quint16 moduleIndex) override;
