...
namespace LBL
{
    namespace SCItem
    {
        ...
        int LBLAbstractSCItem::maxPortCount() const
        {
            return 20;
        }

        bool LBLAbstractSCItem::hasMS9570() const
        {
            return true;
        }

        bool LBLAbstractSCItem::hasNT68400() const
        {
            return true;
        }

        bool LBLAbstractSCItem::hasAndroid() const
        {
            return true;
        }
        ...
        quint16 LBLAbstractSCItem::writeSCNT68400Resolution(quint8 value, bool sync, int msec)
        {
            Q_UNUSED(value);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        QByteArray LBLAbstractSCItem::readSCNT68400Resolution(bool sync, int msec)
        {
            Q_UNUSED(sync);
            Q_UNUSED(msec);
            return QByteArray();
        ...
        quint8 LBLAbstractSCItem::getSCNT68400Resolution()
        {
            return quint8();
        }

        quint16 LBLAbstractSCItem::writeSC10BitSource(quint8 value, bool sync, int msec)
        {
            Q_UNUSED(value);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        QByteArray LBLAbstractSCItem::readSC10BitSource(bool sync, int msec)
        {
            Q_UNUSED(sync);
            Q_UNUSED(msec);
            return QByteArray();
        ...
        quint8 LBLAbstractSCItem::getSC10BitSource()
        {
            return quint8();
        }

        quint16 LBLAbstractSCItem::writeSCLowDelay(quint8 value, bool sync, int msec)
        {
            Q_UNUSED(value);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        QByteArray LBLAbstractSCItem::readSCLowDelay(bool sync, int msec)
        {
            Q_UNUSED(sync);
            Q_UNUSED(msec);
            return QByteArray();
        ...
        quint8 LBLAbstractSCItem::getSCLowDelay()
        {
            return quint8();
        }
        ...
        quint16 LBLAbstractSCItem::writeXMICParam(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(value)
        ...
        QByteArray LBLAbstractSCItem::readXMICParam(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLAbstractSCItem::clearDeadPoint(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLAbstractSCItem::writeLinearTableFile(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(value)
        ...
        quint16 LBLAbstractSCItem::writeLowGrayCalibrationDataErase(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLAbstractSCItem::writeLowGrayCalibrationDataSave(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLAbstractSCItem::writeLowGrayCalibrationDataReload(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLAbstractSCItem::readAllHDMIAdvanceData_PIP(quint8 param, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(param);
            Q_UNUSED(channel);
            Q_UNUSED(sync);
        ...
        quint16 LBLAbstractSCItem::writeHDMIOutputSource(quint8 hdmi1, quint8 hdmi2, quint8 dp, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(hdmi1);
            Q_UNUSED(hdmi2);
            Q_UNUSED(dp);
        ...
        quint16 LBLAbstractSCItem::readHDMIOutputSource(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        QList<quint8> LBLAbstractSCItem::getHDMIOutputSource()
        {
            return QList<quint8>();
        }


        quint16 LBLAbstractSCItem::writeDP_TX_Pcon600(quint8 hdmi1, quint8 hdmi2, quint8 dp, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(hdmi1);
            Q_UNUSED(hdmi2);
            Q_UNUSED(dp);
        ...
        quint16 LBLAbstractSCItem::readDP_TX_Pcon600(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        bool  LBLAbstractSCItem::getDP_TX_Pcon600(quint8 &hdmi1, quint8 &hdmi2, quint8 &dp)
        {
            Q_UNUSED(hdmi1);
            Q_UNUSED(hdmi2);
            Q_UNUSED(dp);
        ...
        quint16 LBLAbstractSCItem::writeDP_TX_2ndPlus(quint8 param, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(param);
            Q_UNUSED(channel);
            Q_UNUSED(sync);
        ...
        quint16 LBLAbstractSCItem::readDP_TX_2ndPlus(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        quint8 LBLAbstractSCItem::getDP_TX_2ndPlus()
        {
            return quint8();
        }
        ...
        quint16 LBLAbstractSCItem::writeHDIMIAudioVolume(quint8 param, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(param);
            Q_UNUSED(channel);
            Q_UNUSED(sync);
        ...
        quint16 LBLAbstractSCItem::readHDIMIAudioVolume(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        quint8 LBLAbstractSCItem::getHDIMIAudioVolume()
        {
            return quint8();
        }

        quint16 LBLAbstractSCItem::writeHDIMISharpness(quint8 param, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(param);
            Q_UNUSED(channel);
            Q_UNUSED(sync);
        ...
        quint16 LBLAbstractSCItem::readHDIMISharpness(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        quint8 LBLAbstractSCItem::getHDIMISharpness()
        {
            return quint8();
        }

        quint16 LBLAbstractSCItem::writeHDIMIDisplayArea(QSize value, quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(value);
            Q_UNUSED(channel);
            Q_UNUSED(sync);
        ...
        quint16 LBLAbstractSCItem::readHDIMIDisplayArea(quint8 channel, bool sync, int msec)
        {
            Q_UNUSED(channel);
            Q_UNUSED(sync);
            Q_UNUSED(msec);
        ...
        QSize LBLAbstractSCItem::getHDIMIDisplayArea()
        {
            return QSize();
        }

        QByteArray LBLAbstractSCItem::GetEDIDData()
        {
            return QByteArray();
        }
        quint16 LBLAbstractSCItem::writeHDMIEDID(int dataGroupIndex, quint8* pDataBuff,int dataLen)
        {
            Q_UNUSED(dataGroupIndex);
            Q_UNUSED(pDataBuff);
            Q_UNUSED(dataLen);
            return quint16();
        }
        quint16 LBLAbstractSCItem::writeFacTest_UpdateEDID(quint8 dataGroupIndex, quint8* pDataBuff, quint8 dataLen, bool sync, int msec)
        {
            Q_UNUSED(dataGroupIndex);
            Q_UNUSED(pDataBuff);
            Q_UNUSED(dataLen);
