    ...
    namespace SCItem
    {
        ...
        public:
            ...
            *********************************************************************************************************/
            ...
            virtual quint16 writeXMICParam(quint8 port, quint8 module, QByteArray value, bool sync, int msec) override;
            virtual QByteArray readXMICParam(quint8 port, quint8 module, bool sync, int msec) override;
            virtual quint16 clearDeadPoint(quint8 port, quint8 module, bool sync, int msec) override;
            ...
            *********************************************************************************************************/
            ...
            virtual quint16 writeDP_TX_Pcon600(quint8 hdmi1, quint8 hdmi2, quint8 dp, quint8 channel, bool sync, int msec) override;
            virtual quint16 readDP_TX_Pcon600(quint8 channel, bool sync, int msec) override;
            virtual bool    getDP_TX_Pcon600(quint8 &hdmi1, quint8 &hdmi2, quint8 &dp) override;

            virtual quint16 writeDP_TX_2ndPlus(quint8 param, quint8 channel, bool sync, int msec) override;
            virtual quint16 readDP_TX_2ndPlus(quint8 channel, bool sync, int msec) override;
            virtual quint8  getDP_TX_2ndPlus() override;
