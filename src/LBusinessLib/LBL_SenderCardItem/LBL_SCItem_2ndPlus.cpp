...
#define LBL_TAG_SENDERCARD2NDPLUS "SenderCard_2ndPlus"
namespace LBL
{
	namespace SCItem
	{
		...
		quint16 SenderCardItem_2ndPlus::upgradeFile(bool sync, int msec, quint16 fileType, QString fileName)
		{
			Q_D(SenderCardItem_2ndPlus);
			return d->m_FileTransfer->common_UpgradeFile(sync, msec, fileType, fileName);
		}

		quint16 SenderCardItem_2ndPlus::upgradeFile(bool sync, int msec, quint16 fileType, QByteArray data)
		{
			Q_D(SenderCardItem_2ndPlus);
