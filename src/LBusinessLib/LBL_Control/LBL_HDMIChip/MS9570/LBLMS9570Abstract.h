...
namespace LBL
{
    namespace MS9570
    {
        ...
        public:
            ...
            virtual quint16	writeOutputResolutionInfo(quint32 param1, quint32 param2, bool sync, int msec)=0;
            ...
            virtual QString	getInputResolutionInfo()=0;

            virtual quint16	writeHDMIEDID(int index, quint8* pdata,int dataLen)=0;
