...
namespace LBL
{
    namespace RC
    {
        ...
        quint16 LBLReceiveCardCentralCtrl::writeXMICParam(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            QByteArray tempData;
            tempData.append(value);
            quint32 addr = 0x400;
        ...
        QByteArray LBLReceiveCardCentralCtrl::readXMICParam(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_D(LBLReceiveCardAbstract);
            quint32 addr = 0x400;
            d->xmICParam = readFPGARegister(port, module, addr, 2048, sync, msec);
            return d->xmICParam;
        }

        quint16 LBLReceiveCardCentralCtrl::writeLinearTableFile(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            QByteArray tempData;
            tempData.append(value);
            quint32 addr = 0x1400;
        ...
        quint16 LBLReceiveCardCentralCtrl::clearDeadPoint(quint8 port, quint8 module, bool sync, int msec)
        {
            QByteArray tempData;
            quint8 value = 1;
            tempData.append(value);
            quint32 addr = 0x2000004;
            return writeFPGARegister(port, module, addr, tempData, sync, msec);
        }
        ...
        quint16 LBLReceiveCardCentralCtrl::writeLowGrayCalibrationDataErase(quint8 port, quint8 module, bool sync, int msec)
        {
            QByteArray tempData;
            quint8 value = 0x20;
            tempData.append(value);
        ...
        quint16 LBLReceiveCardCentralCtrl::writeLowGrayCalibrationDataSave(quint8 port, quint8 module, bool sync, int msec)
        {
            QByteArray tempData;
            quint8 value = 8;
            tempData.append(value);
        ...
        quint16 LBLReceiveCardCentralCtrl::writeLowGrayCalibrationDataReload(quint8 port, quint8 module, bool sync, int msec)
        {
            QByteArray tempData;
            quint8 value = 0x20;
            tempData.append(value);
        ...
        quint16 LBLReceiveCardCentralCtrl::write10BitGammaDataReload(quint8 port, quint8 module, bool sync, int msec)
        {
            QByteArray tempData;
            quint8 value = 0x10;
            tempData.append(value);
