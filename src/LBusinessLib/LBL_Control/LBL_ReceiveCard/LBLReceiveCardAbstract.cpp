...
namespace LBL
{
    namespace RC
    {
        ...
        quint16 LBLReceiveCardAbstract::writeXMICParam(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            Q_UNUSED(port)
                Q_UNUSED(module)
                Q_UNUSED(value)
        ...
        QByteArray LBLReceiveCardAbstract::readXMICParam(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
        ...
        quint16 LBLReceiveCardAbstract::writeLinearTableFile(quint8 port, quint8 module, QByteArray value, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(value)
        ...
        quint16 LBLReceiveCardAbstract::clearDeadPoint(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
                Q_UNUSED(module)
                Q_UNUSED(sync)
        ...
        quint16 LBLReceiveCardAbstract::writeLowGrayCalibrationDataErase(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
                Q_UNUSED(module)
                Q_UNUSED(sync)
        ...
        quint16 LBLReceiveCardAbstract::writeLowGrayCalibrationDataSave(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
                Q_UNUSED(module)
                Q_UNUSED(sync)
        ...
        quint16 LBLReceiveCardAbstract::writeLowGrayCalibrationDataReload(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
                Q_UNUSED(module)
                Q_UNUSED(sync)
        ...
        quint16 LBLReceiveCardAbstract::write10BitGammaDataReload(quint8 port, quint8 module, bool sync, int msec)
        {
            Q_UNUSED(port)
            Q_UNUSED(module)
            Q_UNUSED(sync)
