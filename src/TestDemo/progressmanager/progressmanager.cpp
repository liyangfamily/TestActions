...
void ProgressManagerPrivate::init()
{
    ...
    m_summaryProgressBar->setMinimumWidth(100);
	...
	App::statusBar->addWidget(m_statusBarWidget);
    ...
    toggleProgressView->setIcon(QIcon(":/TestDemo/resource/toggleprogressdetails.png"));

    connect(toggleProgressView, &QAction::toggled,
            this, &ProgressManagerPrivate::progressDetailsToggled);
    toggleButton->setDefaultAction(toggleProgressView);
...
QWidget* ProgressManagerPrivate::statusBarWidget()
{
	return m_instance->m_statusBarWidget;
}
