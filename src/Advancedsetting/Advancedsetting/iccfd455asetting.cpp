...
#include "ui_iccfd455asetting.h"
#include "advancedsetting.h"
#include "icadvancedsetting.h"

ICCFD455ASetting::ICCFD455ASetting(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ICCFD455ASetting)
{
    ui->setupUi(this);
...
ICCFD455ASetting::~ICCFD455ASetting()
{
    delete ui;
}

void ICCFD455ASetting::InitForm()
{
    ...
    items<<tr("慢速");
    items<<tr("快速");
    ui->OpeningSpeedRcomboBox->addItems(items);
    ui->OpeningSpeedGcomboBox->addItems(items);
    ui->OpeningSpeedBcomboBox->addItems(items);
...
int ICCFD455ASetting::GetLowGrayscale(unsigned char value)
{
    switch (value & 0xC0)
    {
    case 0x00:
...
int ICCFD455ASetting::GetColBlankAdj(unsigned char value)
{
...
bool ICCFD455ASetting::GetColBlankEnhance(unsigned char value)
{
    if ((value & 0x10) == 0x10)
    {
        return false;
...
int ICCFD455ASetting::GetColumnBlankTime(unsigned char value)
{
    return (value & 0x01);
}
int ICCFD455ASetting::GetCouplingStrengthAdj(unsigned char value)
{
    return (value >> 2) & 0x03;
}
int ICCFD455ASetting::GetCouplingRangeAdj(unsigned char value)
{
    return (value >> 5) & 0x03;
}
bool ICCFD455ASetting::GetCouplingOptimization(unsigned char value)
{
    if ((value & 0x01) == 0x01)
    {
        return true;
...
bool ICCFD455ASetting::GetPreDriveEnablement(unsigned char value)
{
    if ((value & 0x10) == 0x10)
    {
        return true;
...
int ICCFD455ASetting::GetPreDriveMode(unsigned char value)
{
    return ((value >> 4) & 0x01);
}
int ICCFD455ASetting::GetPreDriveTime(unsigned char value)
{
    return ((value >> 2) & 0x03);
}
int ICCFD455ASetting::GetLowGrayStrength(unsigned char valuelow,unsigned char valuehigh)
{
    int value = (uchar)valuelow + (uchar)valuehigh * 256;
    int value1 = ((value >> 7) & 0x1F);
    return (32 - (value1 + 1));
}
int ICCFD455ASetting::GetLowGrayTime(unsigned char value)
{
    return (value >> 7) & 0x01;
}
bool ICCFD455ASetting::GetDynamicEnergySaving(unsigned char value)
{
...
int ICCFD455ASetting::GetWakeupSetting(unsigned char value)
{
    return ((value) & 0x01);
}
int ICCFD455ASetting::GetOpenCircuitDetectionThreshold(unsigned char value)
{
    return (value & 0x03);
}
int ICCFD455ASetting::GetOpenTestPointAdj(unsigned char value)
{
    return ((value >> 1) & 0x01);
}
bool ICCFD455ASetting::GetOpenCircuitProtcetEnable(unsigned char value)
{
    if ((value & 0x02) == 0x02)
    {
        return true;
...
bool ICCFD455ASetting::GetOpenCircuitDynamicDetec(unsigned char value)
{
...
int ICCFD455ASetting::GetScanMode(unsigned char value)
{
    return (value & 0x01);
}
bool ICCFD455ASetting::GetGclkDoubleAlong(unsigned char value)
{
    if ((value & 0x04) == 0x04)
    {
        return true;
...
int ICCFD455ASetting::GetConstantCurrentPoint(unsigned char value)
{
    switch ((value >> 3) & 0x03)
    {
    case 0x00:
...
bool ICCFD455ASetting::GetGDMixing(unsigned char value)
{
    if ((value & 0x08) == 0x08)
    {
        return true;
...
int ICCFD455ASetting::GetPWMGraySetting(unsigned char value)
{
    return ((value >> 2) & 0x01);
}
bool ICCFD455ASetting::GetLowGrayDisplayOptimization(unsigned char value)
{
...
int ICCFD455ASetting::GetLowGrayOptimizationMode(unsigned char value)
{
    return ((value >> 1) & 0x01);
}
int ICCFD455ASetting::GetCurrentGear(unsigned char value)
{
    return ((value >> 4) & 0x03);
}
int ICCFD455ASetting::GetCurrentGray(unsigned char value)
{
    return ((value >> 5) & 0x01);
}
int ICCFD455ASetting::GetCurrentGraySetting(unsigned char value)
{
    return ((value >> 6) & 0x03);
}

int ICCFD455ASetting::GetOpeningSpeed(unsigned char value)
{
    switch (value & 0x40)
    {
    case 0x00:
...
void ICCFD455ASetting::LoadForm()
{
    ...
    ui->GDMixingRcheckBox->setChecked(GetGDMixing((uchar)ICPara[262]));
    ui->GDMixingGcheckBox->setChecked(GetGDMixing((uchar)ICPara[264]));
    ui->GDMixingBcheckBox->setChecked(GetGDMixing((uchar)ICPara[266]));
    ...
    ui->OpeningSpeedRcomboBox->setCurrentIndex(GetOpeningSpeed((uchar)ICPara[269]));
    ui->OpeningSpeedGcomboBox->setCurrentIndex(GetOpeningSpeed((uchar)ICPara[271]));
    ui->OpeningSpeedBcomboBox->setCurrentIndex(GetOpeningSpeed((uchar)ICPara[273]));
}
...
void ICCFD455ASetting::SetRegValue(int Num, int RGB, int hl, unsigned char value1, unsigned char value2)
{
    unsigned char value = (uchar)ICPara[256 + (Num - 1) * 6 + RGB * 2 + hl];

    value &= value1;
    value |= value2;

    ICPara[256 + (Num - 1) * 6 + RGB * 2 + hl] = value;
}
void ICCFD455ASetting::SetLowGrayscale(int index, int RGB)
{
    switch (index)
    {
    case 0:
        SetRegValue(1, RGB, 1, 0x3F, 0x00);
        break;
    case 1:
        SetRegValue(1, RGB, 1, 0x3F, 0x40);
        break;
    case 2:
        SetRegValue(1, RGB, 1, 0x3F, 0x80);
        break;
    case 3:
        SetRegValue(1, RGB, 1, 0x3F, 0xC0);
        break;
    }
}
void ICCFD455ASetting::SetColBlankAdj(int index, int RGB)
{
    switch(index)
    {
    case 0:
...
void ICCFD455ASetting::SetColBlankEnhance(bool check,int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetColumnBlankTime(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetCouplingStrengthAdj(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetCouplingRangeAdj(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetCouplingOptimization(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetPreDriveEnablement(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetPreDriveMode(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetPreDriveTime(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetLowGrayStrength(int index, int RGB)
{
    int value = (uchar)ICPara[268 + RGB * 2 + 0] + (uchar)ICPara[268 + RGB * 2 + 1] * 256;

    value &= 0xF07F;
    value |= ((32 - (index + 1)) << 7);

    ICPara[268 + RGB * 2 + 0] = (unsigned char)(value & 0xFF);
    ICPara[268 + RGB * 2 + 1] = (unsigned char)((value >> 8) & 0xFF);
}
void ICCFD455ASetting::SetLowGrayTime(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetDynamicEnergySaving(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetWakeupSetting(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetOpenCircuitDetectionThreshold(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetOpenTestPointAdj(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetOpenCircuitProtcetEnable(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetOpenCircuitDynamicDetec(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetScanMode(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetGclkDoubleAlong(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetConstantCurrentPoint(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetGDMixing(bool check, int RGB)
{
    if (check)
    {
        SetRegValue(2, RGB, 0, 0xF7, 0x08);
    }
    else
    {
        SetRegValue(2, RGB, 0, 0xF7, 0x00);
    }
}
void ICCFD455ASetting::SetPWMGraySetting(int index, int RGB)
{
    switch (index)
    {
    case 0:
        SetRegValue(2, RGB, 0, 0xFB, 0x00);
        break;
    case 1:
        SetRegValue(2, RGB, 0, 0xFB, 0x04);
        break;
    default:
        break;
    }
}
void ICCFD455ASetting::SetLowGrayDisplayOptimization(bool check, int RGB)
{
    if (check)
    {
...
void ICCFD455ASetting::SetLowGrayOptimizationMode(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetCurrentGear(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetCurrentGray(int index, int RGB)
{
    switch(index)
    {
    case 0:
...
void ICCFD455ASetting::SetCurrentGraySetting(int index, int RGB)
{
    switch (index)
    {
    case 0:
...
void ICCFD455ASetting::SetOpeningSpeed(int index, int RGB)
{
    switch (index)
    {
    case 0:
        SetRegValue(3, RGB, 1, 0xBF, 0x00);
        break;
    case 1:
        SetRegValue(3, RGB, 1, 0xBF, 0x40);
        break;
    }
}

void ICCFD455ASetting::on_SettingpushButton_clicked()
{
    ...
    SetGDMixing(ui->GDMixingRcheckBox->isChecked(),0);
    SetGDMixing(ui->GDMixingGcheckBox->isChecked(),1);
    SetGDMixing(ui->GDMixingBcheckBox->isChecked(),2);
...
//    {
//        ICPara[135] = ui->CurrentGrayBrightnessRspinBox->value();
//    }
//    if (ui->CurrentGrayGcomboBox->currentIndex() == 0x01)
//    {
//        ICPara[136] = ui->CurrentGrayBrightnessGspinBox->value();
//    }
//    if (ui->CurrentGrayBcomboBox->currentIndex() == 0x01)
//    {
//        ICPara[137] = ui->CurrentGrayBrightnessBspinBox->value();
//    }


    SetOpeningSpeed(ui->OpeningSpeedRcomboBox->currentIndex(),0);
    SetOpeningSpeed(ui->OpeningSpeedGcomboBox->currentIndex(),1);
    SetOpeningSpeed(ui->OpeningSpeedBcomboBox->currentIndex(),2);
...
//void ICCFD455ASetting::on_CurrentGrayRcomboBox_currentIndexChanged(int index)
//{
//    if (index == 0x01)
//    {
...
//void ICCFD455ASetting::on_CurrentGrayGcomboBox_currentIndexChanged(int index)
//{
//    if (index == 0x01)
//    {
...
//void ICCFD455ASetting::on_CurrentGrayBcomboBox_currentIndexChanged(int index)
//{
//    if (index == 0x01)
//    {
...
void ICCFD455ASetting::on_AdvancedSettingpushButton_clicked()
{
